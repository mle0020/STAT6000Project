...
# Visualization
lda.data <- cbind(wine.train, predict(wine.model)$x)
...
for (i in 1:10) {
  ...
  knn.pred <- knn(train,test,wineTrain_Target,k=39)
  errors <- mean(knn.pred$class == test$Quality)
}

#Test model performance using test error.
